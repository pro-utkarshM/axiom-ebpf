...
pub extern "C" fn _start() -> ! {
    ...
    let insns =[
        ...
        // Value: 0x006B636954
        BpfInsn { code: 0xb7, dst_src: 0x01, off: 0, imm: 0x6c636954 }, // "Tick" (oops 'l' is 6c)
        ...
        // r1 = 0x6b636954 (imm32)
        BpfInsn { code: 0xb7, dst_src: 0x01, off: 0, imm: 0x6b636954 },
        
        // *(u32 *)(r10 - 4) = r1 (STX, MEM, W=0 = 4 bytes? No, BPF_W=0, BPF_DW=3)
        // code = BPF_STX | BPF_MEM | BPF_W (0x63)
        BpfInsn { code: 0x63, dst_src: 0x1a, off: -4, imm: 0 }, // src=r1(1), dst=r10(a)
        ...
        BpfInsn { code: 0x7b, dst_src: 0x1a, off: -8, imm: 0 }, 
        
        // r1 = 0x6b636954 ("Tick")
        BpfInsn { code: 0xb7, dst_src: 0x01, off: 0, imm: 0x6b636954 },
        // *(u32 *)(r10 - 8) = r1 (STX, MEM, W=0 -> 0x63)
        // Writing to offset -8 puts "Tick" at -8. Nulls follow at -4.
        BpfInsn { code: 0x63, dst_src: 0x1a, off: -8, imm: 0 },
        
        // r1 = r10
        BpfInsn { code: 0xbf, dst_src: 0x0a, off: 0, imm: 0 },
        
        // r1 += -8
        BpfInsn { code: 0x07, dst_src: 0x01, off: 0, imm: -8 },
        
        // r2 = 5
        BpfInsn { code: 0xb7, dst_src: 0x02, off: 0, imm: 5 },
